...
export default function EquipmentPage() {
  const { equipment, isLoading, error, refresh } = useEquipment();
  ...
  return (
    <DashboardLayout title="Equipment" notificationCount={0}>
      <div className="space-y-6">
        <EquipmentHeader onRefresh={refresh} isLoading={isLoading} />
        <EquipmentFilters
          search={search}
