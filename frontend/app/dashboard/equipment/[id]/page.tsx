...
export default function EquipmentDetailPage(props: {
  ...
  const { selectedEquipment, isLoading, error, deleteEquipment } = useEquipment(
    params.id
  );
  const [activeTab, setActiveTab] = useState<
    "info" | "history" | "work-orders"
  >("info");
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <dd className="text-sm text-gray-500 dark:text-gray-400">
                      {selectedEquipment.locationName}
                    </dd>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <dd className="text-sm text-gray-500 dark:text-gray-400">
                      ...
                      {selectedEquipment.manufacturer
                        ? `by ${selectedEquipment.manufacturer}`
                        : ""}
                    </dd>
                  </div>
                </div>
